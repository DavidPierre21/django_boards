...
class PasswordResetMailTests(TestCase):
    def setUp(self):
        ...
        self.response = self.client.post(reverse_lazy('password_reset'), { 'email': 'john@doe.com' })
    ...
    def test_email_body(self):
        ...
        uid = context.get('uid')
        password_reset_token_url = reverse_lazy('password_reset_confirm', kwargs={
            'uidb64': uid,
            'token': token
        })
...
class PasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        url = reverse_lazy('password_reset_confirm', kwargs={'uidb64': self.uid, 'token': self.token})
